...
const Departments = () => (
  <div className="min-h-screen">
    ...
    <section className="relative h-[300px] overflow-hidden">
      <img src={heroCampus} alt="Departments" className="absolute inset-0 w-full h-full object-cover" />
      <div className="absolute inset-0 bg-hero-overlay/80" />
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4">
        <h1 className="text-4xl md:text-5xl font-heading font-bold text-primary-foreground mb-3">Our Departments</h1>
      </div>
    </section>
    ...
    <section className="section-padding bg-background">
      <div className="container-custom text-center max-w-3xl mx-auto">
        ...
        <p className="text-muted-foreground leading-relaxed">
          Study World College of Engineering offers undergraduate programs approved by AICTE and affiliated to Anna University. Each department is equipped with state-of-the-art laboratories and experienced faculty.
        </p>
      </div>
    </section>
